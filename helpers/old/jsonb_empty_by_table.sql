CREATE FUNCTION public.jsonb_empty_by_table ("relid" OID)
    RETURNS JSONB
    AS $$
DECLARE
    "columns" CONSTANT TEXT[] NOT NULL = public.get_columns("relid");
    "result"           JSONB           = '{}';
    "column"           TEXT;
BEGIN
...
COMMENT ON FUNCTION public.jsonb_empty_by_table (OID) IS 'get jsonb object with empty columns from table $1';
