CREATE FUNCTION public.jsonb_pk_table_object ("relid" OID, "record" JSONB)
    RETURNS JSONB
    AS $$
DECLARE
    -- main
...
COMMENT ON FUNCTION public.jsonb_pk_table_object (OID, JSONB) IS 'get jsonb object with primary key columns from table $1 and values from record $2';
