...
DECLARE
    ...
    -- ch  - changed
    -- main
    "ch_record"  CONSTANT JSONB             = to_jsonb(NEW) OPERATOR ( public.- ) to_jsonb(OLD);
...
BEGIN
    ...
    "lb_record" = public.update_using_records("lb_table", "ch_columns", OLD, NEW);
    ...
    PERFORM public.update_using_records("lbt_table", "ch_columns", NEW, NEW);
