...
- [ ] проверить корректность колонок `is_tran`, `is_default_lang` в представлении `i18n`
- [ ] проверить корректность одноименных колонок (`title`) в представлении `i18n`
- [ ] написать файл с тестированием таблицами i18n_words и i18n_product
    ...
    - [x] `UPDATE` обновить `id=-1`, где `id=1` и существуют все переводы - смена `primary keys`, проследить, как пройдет обновление (ok)
